...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public partial class ColumnsApi : IColumnsApi
    {
        ...
        public FactSet.AnalyticsAPI.Engines.Client.ApiResponse< Dictionary<string, ColumnSummary> > GetPAColumnsWithHttpInfo (string name = default(string), string category = default(string), string directory = default(string))
        {
            ...
            if (name != null)
            {
                foreach (var _kvp in FactSet.AnalyticsAPI.Engines.Client.ClientUtils.ParameterToMultiMap("", "name", name))
                {
            ...
            if (category != null)
            {
                foreach (var _kvp in FactSet.AnalyticsAPI.Engines.Client.ClientUtils.ParameterToMultiMap("", "category", category))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
            ...
            if (directory != null)
            {
                foreach (var _kvp in FactSet.AnalyticsAPI.Engines.Client.ClientUtils.ParameterToMultiMap("", "directory", directory))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
