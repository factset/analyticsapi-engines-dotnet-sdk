...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public partial class GroupsApi : IGroupsApi
    {
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, Group&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<Dictionary<string, Group>>> GetPAGroupsAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Dictionary<string, Group>>("/analytics/lookups/v2/engines/pa/groups", localVarRequestOptions, this.Configuration);
