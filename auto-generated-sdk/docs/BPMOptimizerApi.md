...
namespace Example
{
    public class CancelOptimizationByIdExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling BPMOptimizerApi.CancelOptimizationById: " + e.Message );
...
namespace Example
{
    public class GetOptimizationParametersExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling BPMOptimizerApi.GetOptimizationParameters: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationResultExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling BPMOptimizerApi.GetOptimizationResult: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOptimizationStatusByIdExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling BPMOptimizerApi.GetOptimizationStatusById: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
# **PostAndOptimize**
> StringRoot PostAndOptimize (int? xFactSetApiLongRunningDeadline = null, string cacheControl = null, BPMOptimizationParametersRoot bPMOptimizationParametersRoot = null)
...
namespace Example
{
    public class PostAndOptimizeExample
    {
        public static void Main()
        {
            ...
            {
                // Create and Run BPM optimization
                StringRoot result = apiInstance.PostAndOptimize(xFactSetApiLongRunningDeadline, cacheControl, bPMOptimizationParametersRoot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling BPMOptimizerApi.PostAndOptimize: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
# **PutAndOptimize**
> StringRoot PutAndOptimize (string id, int? xFactSetApiLongRunningDeadline = null, string cacheControl = null, BPMOptimizationParametersRoot bPMOptimizationParametersRoot = null)
...
namespace Example
{
    public class PutAndOptimizeExample
    {
        public static void Main()
        {
            ...
            {
                // Create or Update BPM optimization and run it.
                StringRoot result = apiInstance.PutAndOptimize(id, xFactSetApiLongRunningDeadline, cacheControl, bPMOptimizationParametersRoot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling BPMOptimizerApi.PutAndOptimize: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
