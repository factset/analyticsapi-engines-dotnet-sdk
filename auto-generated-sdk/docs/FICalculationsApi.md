...
<a name="cancelficalculationbyid"></a>
...
namespace Example
{
    public class CancelFICalculationByIdExample
    {
...
namespace Example
{
    public class GetFICalculationByIdExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling FICalculationsApi.GetFICalculationById: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class RunFICalculationExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling FICalculationsApi.RunFICalculation: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
