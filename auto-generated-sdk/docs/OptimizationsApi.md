# FactSet.AnalyticsAPI.Engines.Api.OptimizationsApi
...
<a name="cancelaxiomaoptimizationbyid"></a>
...
namespace Example
{
    public class CancelAxiomaOptimizationByIdExample
    {
...
<a name="getaxiomaoptimizationbyid"></a>
...
namespace Example
{
    public class GetAxiomaOptimizationByIdExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling OptimizationsApi.GetAxiomaOptimizationById: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
<a name="runaxiomaoptimization"></a>
# **RunAxiomaOptimization**
> void RunAxiomaOptimization (AxiomaEquityOptimizationParameters axiomaEquityOptimizationParameters = null)
...
namespace Example
{
    public class RunAxiomaOptimizationExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling OptimizationsApi.RunAxiomaOptimization: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
