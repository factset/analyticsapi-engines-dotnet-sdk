# FactSet.AnalyticsAPI.Engines.Api.PricingSourcesApi
...
namespace Example
{
    public class GetPAPricingSourcesExample
    {
        public static void Main()
        {
            ...
            var name = name_example;  // string | PA pricing sources name (optional)  (default to "")
            var category = category_example;  // string | PA pricing sources category (optional)  (default to "")
            var directory = directory_example;  // string | The directory to get the PA pricing sources in (optional)  (default to "")
            ...
            {
                Debug.Print("Exception when calling PricingSourcesApi.GetPAPricingSources: " + e.Message );
