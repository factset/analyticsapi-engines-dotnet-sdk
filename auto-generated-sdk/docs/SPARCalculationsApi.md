...
> SPARCalculationParametersCalculationMetaCalculationParameters GetCalculationParameters (string id)
...
# **PostAndCalculate**
> CalculationStatusCalculationStatusMetaDataAndMetaModel PostAndCalculate (int? xFactSetApiLongRunningDeadline = null, string cacheControl = null, SPARCalculationParametersCalculationMetaCalculationParameters sPARCalculationParametersCalculationMetaCalculationParameters = null)
...
namespace Example
{
    public class PostAndCalculateExample
    {
        public static void Main()
        {
            ...
            var sPARCalculationParametersCalculationMetaCalculationParameters = new SPARCalculationParametersCalculationMetaCalculationParameters(); // SPARCalculationParametersCalculationMetaCalculationParameters | Calculation Parameters (optional) 
...
# **PutAndCalculate**
> CalculationStatusCalculationStatusMetaDataAndMetaModel PutAndCalculate (string id, int? xFactSetApiLongRunningDeadline = null, string cacheControl = null, SPARCalculationParametersCalculationMetaCalculationParameters sPARCalculationParametersCalculationMetaCalculationParameters = null)
