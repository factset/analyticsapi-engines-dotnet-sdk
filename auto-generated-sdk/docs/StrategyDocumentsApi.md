...
namespace Example
{
    public class GetAxiomaEquityStrategyDocumentsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling StrategyDocumentsApi.GetAxiomaEquityStrategyDocuments: " + e.Message );
...
namespace Example
{
    public class GetAxiomaFIStrategyDocumentsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling StrategyDocumentsApi.GetAxiomaFIStrategyDocuments: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetBarraStrategyDocumentsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling StrategyDocumentsApi.GetBarraStrategyDocuments: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetNorthfieldStrategyDocumentsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling StrategyDocumentsApi.GetNorthfieldStrategyDocuments: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
