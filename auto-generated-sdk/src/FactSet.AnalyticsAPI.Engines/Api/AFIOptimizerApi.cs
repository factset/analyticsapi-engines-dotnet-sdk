...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public partial class AFIOptimizerApi : IAFIOptimizerApi
    {
        ...
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<AFIOptimizationParametersRoot> localVarResponse = GetOptimizationParametersWithHttpInfo(id);
        ...
        /// <param name="id">from url, provided from the location header in the Create and Run AFI optimization endpoint</param>
        /// <returns>ApiResponse of AFIOptimizationParametersRoot</returns>
        public FactSet.AnalyticsAPI.Engines.Client.ApiResponse<AFIOptimizationParametersRoot> GetOptimizationParametersWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<AFIOptimizationParametersRoot> localVarResponse = await GetOptimizationParametersWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
