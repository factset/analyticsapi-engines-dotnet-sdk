...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public interface IAccountsApiSync : IApiAccessor
    {
        ...
        /// <returns>SPARAccountsObjectDataAndMetaModel</returns>
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accountPath">URL encoded account path</param>
        /// <returns>ApiResponse of SPARAccountsObjectDataAndMetaModel</returns>
        ApiResponse<SPARAccountsObjectDataAndMetaModel> GetSPARReturnsTypeWithHttpInfo(string accountPath);
    ...
    public interface IAccountsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of SPARAccountsObjectDataAndMetaModel</returns>
        System.Threading.Tasks.Task<SPARAccountsObjectDataAndMetaModel> GetSPARReturnsTypeAsync(string accountPath, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="accountPath">URL encoded account path</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse of SPARAccountsObjectDataAndMetaModel</returns>
        System.Threading.Tasks.Task<ApiResponse<SPARAccountsObjectDataAndMetaModel>> GetSPARReturnsTypeWithHttpInfoAsync(string accountPath, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        /// <param name="accountPath">URL encoded account path</param>
        /// <returns>SPARAccountsObjectDataAndMetaModel</returns>
        public SPARAccountsObjectDataAndMetaModel GetSPARReturnsType(string accountPath)
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<SPARAccountsObjectDataAndMetaModel> localVarResponse = GetSPARReturnsTypeWithHttpInfo(accountPath);
        ...
        /// <param name="accountPath">URL encoded account path</param>
        /// <returns>ApiResponse of SPARAccountsObjectDataAndMetaModel</returns>
        public FactSet.AnalyticsAPI.Engines.Client.ApiResponse<SPARAccountsObjectDataAndMetaModel> GetSPARReturnsTypeWithHttpInfo(string accountPath)
        {
            ...
            {
                { 200, typeof(SPARAccountsObjectDataAndMetaModel) },
            ...
            var localVarResponse = this.Client.Get<SPARAccountsObjectDataAndMetaModel>("/analytics/engines/spar/v3/accounts/{accountPath}/returns-type", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SPARAccountsObjectDataAndMetaModel</returns>
        public async System.Threading.Tasks.Task<SPARAccountsObjectDataAndMetaModel> GetSPARReturnsTypeAsync(string accountPath, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<SPARAccountsObjectDataAndMetaModel> localVarResponse = await GetSPARReturnsTypeWithHttpInfoAsync(accountPath, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse of SPARAccountsObjectDataAndMetaModel</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<SPARAccountsObjectDataAndMetaModel>> GetSPARReturnsTypeWithHttpInfoAsync(string accountPath, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'accountPath' is set
            if (accountPath == null)
                throw new FactSet.AnalyticsAPI.Engines.Client.ApiException(400, "Missing required parameter 'accountPath' when calling AccountsApi->GetSPARReturnsType");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<SPARAccountsObjectDataAndMetaModel>("/analytics/engines/spar/v3/accounts/{accountPath}/returns-type", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
