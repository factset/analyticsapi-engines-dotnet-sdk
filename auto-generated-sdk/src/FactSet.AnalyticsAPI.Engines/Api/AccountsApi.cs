...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        {
             FactSet.AnalyticsAPI.Engines.Client.ApiResponse<AccountDirectories> localVarResponse = GetAccountsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the accounts and sub-directories in</param>
        /// <returns>ApiResponse of AccountDirectories</returns>
        public FactSet.AnalyticsAPI.Engines.Client.ApiResponse< AccountDirectories > GetAccountsWithHttpInfo (string path)
        {
        ...
        {
             FactSet.AnalyticsAPI.Engines.Client.ApiResponse<AccountDirectories> localVarResponse = await GetAccountsAsyncWithHttpInfo(path);
             return localVarResponse.Data;
        ...
        /// <param name="path">The directory to get the accounts and sub-directories in</param>
        /// <returns>Task of ApiResponse (AccountDirectories)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<AccountDirectories>> GetAccountsAsyncWithHttpInfo (string path)
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.AnalyticsAPI.Engines.Client.ApiException(400, "Missing required parameter 'path' when calling AccountsApi->GetAccounts");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<AccountDirectories>("/analytics/lookups/v2/accounts/{path}", localVarRequestOptions, this.Configuration);
