...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public partial class CalculationsApi : ICalculationsApi
    {
        ...
        /// <returns></returns>
        public CalculationsApi(FactSet.AnalyticsAPI.Engines.Client.Configuration configuration)
        {
        ...
        public FactSet.AnalyticsAPI.Engines.Client.ApiResponse<Object> CancelCalculationByIdWithHttpInfo(string id)
        {
            ...
            if (id == null)
                throw new FactSet.AnalyticsAPI.Engines.Client.ApiException(400, "Missing required parameter 'id' when calling CalculationsApi->CancelCalculationById");
        ...
        public FactSet.AnalyticsAPI.Engines.Client.ApiResponse<CalculationStatus> GetCalculationStatusByIdWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.AnalyticsAPI.Engines.Client.ApiException(400, "Missing required parameter 'id' when calling CalculationsApi->GetCalculationStatusById");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<Object>> RunCalculationWithHttpInfoAsync(Calculation calculation = default(Calculation), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
