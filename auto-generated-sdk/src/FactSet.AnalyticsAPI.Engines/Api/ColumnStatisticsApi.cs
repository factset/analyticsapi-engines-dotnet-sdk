...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public interface IColumnStatisticsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ColumnStatisticRoot> GetPAColumnStatisticsAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<ColumnStatisticRoot>> GetPAColumnStatisticsAsyncWithHttpInfo ();
    ...
    public partial class ColumnStatisticsApi : IColumnStatisticsApi
    {
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ColumnStatisticRoot</returns>
        public async System.Threading.Tasks.Task<ColumnStatisticRoot> GetPAColumnStatisticsAsync ()
        {
             FactSet.AnalyticsAPI.Engines.Client.ApiResponse<ColumnStatisticRoot> localVarResponse = await GetPAColumnStatisticsAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (ColumnStatisticRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<ColumnStatisticRoot>> GetPAColumnStatisticsAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ColumnStatisticRoot>("/analytics/engines/pa/v3/columnstatistics", localVarRequestOptions, this.Configuration);
