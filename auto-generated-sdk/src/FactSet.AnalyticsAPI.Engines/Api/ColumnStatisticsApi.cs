...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public interface IColumnStatisticsApiSync : IApiAccessor
    {
        ...
        /// <returns>StringColumnStatisticDictionaryObjectDataAndMetaModel</returns>
        ...
        /// </remarks>
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of StringColumnStatisticDictionaryObjectDataAndMetaModel</returns>
        ApiResponse<StringColumnStatisticDictionaryObjectDataAndMetaModel> GetPAColumnStatisticsWithHttpInfo();
    ...
    public interface IColumnStatisticsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of StringColumnStatisticDictionaryObjectDataAndMetaModel</returns>
        System.Threading.Tasks.Task<StringColumnStatisticDictionaryObjectDataAndMetaModel> GetPAColumnStatisticsAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse of StringColumnStatisticDictionaryObjectDataAndMetaModel</returns>
        System.Threading.Tasks.Task<ApiResponse<StringColumnStatisticDictionaryObjectDataAndMetaModel>> GetPAColumnStatisticsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ColumnStatisticsApi : IColumnStatisticsApi
    {
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>StringColumnStatisticDictionaryObjectDataAndMetaModel</returns>
        public StringColumnStatisticDictionaryObjectDataAndMetaModel GetPAColumnStatistics()
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<StringColumnStatisticDictionaryObjectDataAndMetaModel> localVarResponse = GetPAColumnStatisticsWithHttpInfo();
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of StringColumnStatisticDictionaryObjectDataAndMetaModel</returns>
        public FactSet.AnalyticsAPI.Engines.Client.ApiResponse<StringColumnStatisticDictionaryObjectDataAndMetaModel> GetPAColumnStatisticsWithHttpInfo()
        {
            ...
            {
                { 200, typeof(StringColumnStatisticDictionaryObjectDataAndMetaModel) },
            };
            ...
            var localVarResponse = this.Client.Get<StringColumnStatisticDictionaryObjectDataAndMetaModel>("/analytics/engines/pa/v3/columnstatistics", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of StringColumnStatisticDictionaryObjectDataAndMetaModel</returns>
        public async System.Threading.Tasks.Task<StringColumnStatisticDictionaryObjectDataAndMetaModel> GetPAColumnStatisticsAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<StringColumnStatisticDictionaryObjectDataAndMetaModel> localVarResponse = await GetPAColumnStatisticsWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse of StringColumnStatisticDictionaryObjectDataAndMetaModel</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<StringColumnStatisticDictionaryObjectDataAndMetaModel>> GetPAColumnStatisticsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<StringColumnStatisticDictionaryObjectDataAndMetaModel>("/analytics/engines/pa/v3/columnstatistics", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
