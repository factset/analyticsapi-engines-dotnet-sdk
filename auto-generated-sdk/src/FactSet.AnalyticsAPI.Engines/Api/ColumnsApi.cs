...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public interface IColumnsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Column> GetPAColumnByIdAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Column>> GetPAColumnByIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get PA columns
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Dictionary<string, ColumnSummary>> GetPAColumnsAsync(string name = default(string), string category = default(string), string directory = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ColumnsApi : IColumnsApi
    {
        ...
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<Column> localVarResponse = await GetPAColumnByIdWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Column)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<Column>> GetPAColumnByIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.AnalyticsAPI.Engines.Client.ApiException(400, "Missing required parameter 'id' when calling ColumnsApi->GetPAColumnById");
        ...
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<Dictionary<string, ColumnSummary>> localVarResponse = await GetPAColumnsWithHttpInfoAsync(name, category, directory, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, ColumnSummary&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<Dictionary<string, ColumnSummary>>> GetPAColumnsWithHttpInfoAsync(string name = default(string), string category = default(string), string directory = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
