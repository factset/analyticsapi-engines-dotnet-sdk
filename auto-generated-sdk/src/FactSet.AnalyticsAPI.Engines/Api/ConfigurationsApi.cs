...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public interface IConfigurationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<VaultConfigurationRoot> GetVaultConfigurationByIdAsync (string id);
        ...
        System.Threading.Tasks.Task<ApiResponse<VaultConfigurationRoot>> GetVaultConfigurationByIdAsyncWithHttpInfo (string id);
        /// <summary>
        /// Get Vault configurations
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<VaultConfigurationSummaryRoot> GetVaultConfigurationsAsync (string account);
        ...
        System.Threading.Tasks.Task<ApiResponse<VaultConfigurationSummaryRoot>> GetVaultConfigurationsAsyncWithHttpInfo (string account);
    ...
    public partial class ConfigurationsApi : IConfigurationsApi
    {
        ...
        /// <param name="id">Vault configuration id to get the details of</param>
        /// <returns>Task of VaultConfigurationRoot</returns>
        public async System.Threading.Tasks.Task<VaultConfigurationRoot> GetVaultConfigurationByIdAsync (string id)
        {
             FactSet.AnalyticsAPI.Engines.Client.ApiResponse<VaultConfigurationRoot> localVarResponse = await GetVaultConfigurationByIdAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">Vault configuration id to get the details of</param>
        /// <returns>Task of ApiResponse (VaultConfigurationRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<VaultConfigurationRoot>> GetVaultConfigurationByIdAsyncWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.AnalyticsAPI.Engines.Client.ApiException(400, "Missing required parameter 'id' when calling ConfigurationsApi->GetVaultConfigurationById");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<VaultConfigurationRoot>("/analytics/engines/vault/v3/configurations/{id}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="account">Required account query parameter to filter configurations for a specific account</param>
        /// <returns>Task of VaultConfigurationSummaryRoot</returns>
        public async System.Threading.Tasks.Task<VaultConfigurationSummaryRoot> GetVaultConfigurationsAsync (string account)
        {
             FactSet.AnalyticsAPI.Engines.Client.ApiResponse<VaultConfigurationSummaryRoot> localVarResponse = await GetVaultConfigurationsAsyncWithHttpInfo(account);
             return localVarResponse.Data;
        ...
        /// <param name="account">Required account query parameter to filter configurations for a specific account</param>
        /// <returns>Task of ApiResponse (VaultConfigurationSummaryRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<VaultConfigurationSummaryRoot>> GetVaultConfigurationsAsyncWithHttpInfo (string account)
        {
            // verify the required parameter 'account' is set
            if (account == null)
                throw new FactSet.AnalyticsAPI.Engines.Client.ApiException(400, "Missing required parameter 'account' when calling ConfigurationsApi->GetVaultConfigurations");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<VaultConfigurationSummaryRoot>("/analytics/engines/vault/v3/configurations", localVarRequestOptions, this.Configuration);
