...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public interface IDatesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<DateParametersSummaryRoot> ConvertPADatesToAbsoluteFormatAsync (string enddate, string componentid, string account, string startdate = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<DateParametersSummaryRoot>> ConvertPADatesToAbsoluteFormatAsyncWithHttpInfo (string enddate, string componentid, string account, string startdate = default(string));
        /// <summary>
        /// Convert Vault dates to absolute format
        /// </summary>
        /// <remarks>
        ...
        /// <param name="startdate">Start Date (optional)</param>
        /// <returns>Task of DateParametersSummaryRoot</returns>
        System.Threading.Tasks.Task<DateParametersSummaryRoot> ConvertVaultDatesToAbsoluteFormatAsync (string enddate, string componentid, string account, string startdate = default(string));
        ...
        /// <param name="startdate">Start Date (optional)</param>
        /// <returns>Task of ApiResponse (DateParametersSummaryRoot)</returns>
        System.Threading.Tasks.Task<ApiResponse<DateParametersSummaryRoot>> ConvertVaultDatesToAbsoluteFormatAsyncWithHttpInfo (string enddate, string componentid, string account, string startdate = default(string));
    ...
    public partial class DatesApi : IDatesApi
    {
        ...
        /// <param name="startdate">Start Date (optional)</param>
        /// <returns>Task of DateParametersSummaryRoot</returns>
        public async System.Threading.Tasks.Task<DateParametersSummaryRoot> ConvertPADatesToAbsoluteFormatAsync (string enddate, string componentid, string account, string startdate = default(string))
        {
             FactSet.AnalyticsAPI.Engines.Client.ApiResponse<DateParametersSummaryRoot> localVarResponse = await ConvertPADatesToAbsoluteFormatAsyncWithHttpInfo(enddate, componentid, account, startdate);
             return localVarResponse.Data;
        ...
        /// <param name="startdate">Start Date (optional)</param>
        /// <returns>Task of ApiResponse (DateParametersSummaryRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<DateParametersSummaryRoot>> ConvertPADatesToAbsoluteFormatAsyncWithHttpInfo (string enddate, string componentid, string account, string startdate = default(string))
        {
            // verify the required parameter 'enddate' is set
            if (enddate == null)
                throw new FactSet.AnalyticsAPI.Engines.Client.ApiException(400, "Missing required parameter 'enddate' when calling DatesApi->ConvertPADatesToAbsoluteFormat");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<DateParametersSummaryRoot>("/analytics/engines/pa/v3/dates", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="startdate">Start Date (optional)</param>
        /// <returns>Task of DateParametersSummaryRoot</returns>
        public async System.Threading.Tasks.Task<DateParametersSummaryRoot> ConvertVaultDatesToAbsoluteFormatAsync (string enddate, string componentid, string account, string startdate = default(string))
        {
             FactSet.AnalyticsAPI.Engines.Client.ApiResponse<DateParametersSummaryRoot> localVarResponse = await ConvertVaultDatesToAbsoluteFormatAsyncWithHttpInfo(enddate, componentid, account, startdate);
             return localVarResponse.Data;
        ...
        /// <param name="startdate">Start Date (optional)</param>
        /// <returns>Task of ApiResponse (DateParametersSummaryRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<DateParametersSummaryRoot>> ConvertVaultDatesToAbsoluteFormatAsyncWithHttpInfo (string enddate, string componentid, string account, string startdate = default(string))
        {
            // verify the required parameter 'enddate' is set
            if (enddate == null)
                throw new FactSet.AnalyticsAPI.Engines.Client.ApiException(400, "Missing required parameter 'enddate' when calling DatesApi->ConvertVaultDatesToAbsoluteFormat");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<DateParametersSummaryRoot>("/analytics/engines/vault/v3/dates", localVarRequestOptions, this.Configuration);
