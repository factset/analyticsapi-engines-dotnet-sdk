...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public interface IFPOOptimizerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<FPOOptimizationParametersRoot> GetOptimizationParametersAsync (string id);
        ...
        System.Threading.Tasks.Task<ApiResponse<FPOOptimizationParametersRoot>> GetOptimizationParametersAsyncWithHttpInfo (string id);
        /// <summary>
        /// Get FPO optimization result by id
        /// </summary>
        /// <remarks>
        ...
        /// <param name="fPOOptimizationParametersRoot">Calculation Parameters (optional)</param>
        /// <returns>Task of ApiResponse (ObjectRoot)</returns>
        System.Threading.Tasks.Task<ApiResponse<ObjectRoot>> PostAndOptimizeAsyncWithHttpInfo (int? xFactSetApiLongRunningDeadline = default(int?), string cacheControl = default(string), FPOOptimizationParametersRoot fPOOptimizationParametersRoot = default(FPOOptimizationParametersRoot));
        /// <summary>
        /// Create or Update FPO optimization and run it.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="fPOOptimizationParametersRoot">Calculation Parameters (optional)</param>
        /// <returns>Task of ObjectRoot</returns>
        System.Threading.Tasks.Task<ObjectRoot> PutAndOptimizeAsync (string id, int? xFactSetApiLongRunningDeadline = default(int?), string cacheControl = default(string), FPOOptimizationParametersRoot fPOOptimizationParametersRoot = default(FPOOptimizationParametersRoot));
        ...
        /// <param name="fPOOptimizationParametersRoot">Calculation Parameters (optional)</param>
        /// <returns>Task of ApiResponse (ObjectRoot)</returns>
        System.Threading.Tasks.Task<ApiResponse<ObjectRoot>> PutAndOptimizeAsyncWithHttpInfo (string id, int? xFactSetApiLongRunningDeadline = default(int?), string cacheControl = default(string), FPOOptimizationParametersRoot fPOOptimizationParametersRoot = default(FPOOptimizationParametersRoot));
    ...
    public partial class FPOOptimizerApi : IFPOOptimizerApi
    {
        ...
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<Object>> CancelOptimizationByIdAsyncWithHttpInfo (string id)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/analytics/engines/fpo/v3/optimizations/{id}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="id">from url, provided from the location header in the Create and Run FPO optimization endpoint</param>
        /// <returns>Task of FPOOptimizationParametersRoot</returns>
        public async System.Threading.Tasks.Task<FPOOptimizationParametersRoot> GetOptimizationParametersAsync (string id)
        {
             FactSet.AnalyticsAPI.Engines.Client.ApiResponse<FPOOptimizationParametersRoot> localVarResponse = await GetOptimizationParametersAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">from url, provided from the location header in the Create and Run FPO optimization endpoint</param>
        /// <returns>Task of ApiResponse (FPOOptimizationParametersRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<FPOOptimizationParametersRoot>> GetOptimizationParametersAsyncWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.AnalyticsAPI.Engines.Client.ApiException(400, "Missing required parameter 'id' when calling FPOOptimizerApi->GetOptimizationParameters");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<FPOOptimizationParametersRoot>("/analytics/engines/fpo/v3/optimizations/{id}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<ObjectRoot>> GetOptimizationResultAsyncWithHttpInfo (string id, string accept = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ObjectRoot>("/analytics/engines/fpo/v3/optimizations/{id}/result", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<ObjectRoot>> GetOptimizationStatusByIdAsyncWithHttpInfo (string id)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ObjectRoot>("/analytics/engines/fpo/v3/optimizations/{id}/status", localVarRequestOptions, this.Configuration);
        ...
        {
             FactSet.AnalyticsAPI.Engines.Client.ApiResponse<ObjectRoot> localVarResponse = await PostAndOptimizeAsyncWithHttpInfo(xFactSetApiLongRunningDeadline, cacheControl, fPOOptimizationParametersRoot);
             return localVarResponse.Data;
        ...
        /// <param name="fPOOptimizationParametersRoot">Calculation Parameters (optional)</param>
        /// <returns>Task of ApiResponse (ObjectRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<ObjectRoot>> PostAndOptimizeAsyncWithHttpInfo (int? xFactSetApiLongRunningDeadline = default(int?), string cacheControl = default(string), FPOOptimizationParametersRoot fPOOptimizationParametersRoot = default(FPOOptimizationParametersRoot))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<ObjectRoot>("/analytics/engines/fpo/v3/optimizations", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="fPOOptimizationParametersRoot">Calculation Parameters (optional)</param>
        /// <returns>Task of ObjectRoot</returns>
        public async System.Threading.Tasks.Task<ObjectRoot> PutAndOptimizeAsync (string id, int? xFactSetApiLongRunningDeadline = default(int?), string cacheControl = default(string), FPOOptimizationParametersRoot fPOOptimizationParametersRoot = default(FPOOptimizationParametersRoot))
        {
             FactSet.AnalyticsAPI.Engines.Client.ApiResponse<ObjectRoot> localVarResponse = await PutAndOptimizeAsyncWithHttpInfo(id, xFactSetApiLongRunningDeadline, cacheControl, fPOOptimizationParametersRoot);
             return localVarResponse.Data;
        ...
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<ObjectRoot>> PutAndOptimizeAsyncWithHttpInfo (string id, int? xFactSetApiLongRunningDeadline = default(int?), string cacheControl = default(string), FPOOptimizationParametersRoot fPOOptimizationParametersRoot = default(FPOOptimizationParametersRoot))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<ObjectRoot>("/analytics/engines/fpo/v3/optimizations/{id}", localVarRequestOptions, this.Configuration);
