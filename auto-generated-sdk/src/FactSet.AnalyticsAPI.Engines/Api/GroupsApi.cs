...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public interface IGroupsApiSync : IApiAccessor
    {
        ...
        /// <returns>StringGroupDictionaryObjectDataAndMetaModel</returns>
        ...
        /// </remarks>
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of StringGroupDictionaryObjectDataAndMetaModel</returns>
        ApiResponse<StringGroupDictionaryObjectDataAndMetaModel> GetPAGroupsWithHttpInfo();
    ...
    public interface IGroupsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of StringGroupDictionaryObjectDataAndMetaModel</returns>
        System.Threading.Tasks.Task<StringGroupDictionaryObjectDataAndMetaModel> GetPAGroupsAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse of StringGroupDictionaryObjectDataAndMetaModel</returns>
        System.Threading.Tasks.Task<ApiResponse<StringGroupDictionaryObjectDataAndMetaModel>> GetPAGroupsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class GroupsApi : IGroupsApi
    {
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>StringGroupDictionaryObjectDataAndMetaModel</returns>
        public StringGroupDictionaryObjectDataAndMetaModel GetPAGroups()
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<StringGroupDictionaryObjectDataAndMetaModel> localVarResponse = GetPAGroupsWithHttpInfo();
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of StringGroupDictionaryObjectDataAndMetaModel</returns>
        public FactSet.AnalyticsAPI.Engines.Client.ApiResponse<StringGroupDictionaryObjectDataAndMetaModel> GetPAGroupsWithHttpInfo()
        {
            ...
            {
                { 200, typeof(StringGroupDictionaryObjectDataAndMetaModel) },
            };
            ...
            var localVarResponse = this.Client.Get<StringGroupDictionaryObjectDataAndMetaModel>("/analytics/engines/pa/v3/groups", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of StringGroupDictionaryObjectDataAndMetaModel</returns>
        public async System.Threading.Tasks.Task<StringGroupDictionaryObjectDataAndMetaModel> GetPAGroupsAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<StringGroupDictionaryObjectDataAndMetaModel> localVarResponse = await GetPAGroupsWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse of StringGroupDictionaryObjectDataAndMetaModel</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<StringGroupDictionaryObjectDataAndMetaModel>> GetPAGroupsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<StringGroupDictionaryObjectDataAndMetaModel>("/analytics/engines/pa/v3/groups", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
