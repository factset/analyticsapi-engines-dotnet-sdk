...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public partial class PACalculationsApi : IPACalculationsApi
    {
        ...
        public FactSet.AnalyticsAPI.Engines.Client.ApiResponse<StringRoot> GetCalculationUnitResultByIdWithHttpInfo(string id, string unitId)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<StringRoot>("/analytics/engines/pa/v3/calculations/{id}/units/{unitId}/result", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<StringRoot>> GetCalculationUnitResultByIdWithHttpInfoAsync(string id, string unitId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<StringRoot>("/analytics/engines/pa/v3/calculations/{id}/units/{unitId}/result", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<CalculationStatusRoot> localVarResponse = await PostAndCalculateWithHttpInfoAsync(xFactSetApiLongRunningDeadline, cacheControl, pACalculationParametersRoot, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            FactSet.AnalyticsAPI.Engines.Client.ApiResponse<CalculationStatusRoot> localVarResponse = await PutAndCalculateWithHttpInfoAsync(id, xFactSetApiLongRunningDeadline, cacheControl, pACalculationParametersRoot, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CalculationStatusRoot)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.Client.ApiResponse<CalculationStatusRoot>> PutAndCalculateWithHttpInfoAsync(string id, int? xFactSetApiLongRunningDeadline = default(int?), string cacheControl = default(string), PACalculationParametersRoot pACalculationParametersRoot = default(PACalculationParametersRoot), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.AnalyticsAPI.Engines.Client.ApiException(400, "Missing required parameter 'id' when calling PACalculationsApi->PutAndCalculate");
