...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public partial class QuantCalculationsApi : IQuantCalculationsApi
    {
        ...
        /// <param name="cacheControl">Standard HTTP header.  Accepts no-store, max-age, max-stale. (optional)</param>
        /// <param name="quantCalculationParametersRoot"> (optional)</param>
        /// <returns>(For 202 status - CalculationStatusRoot)(For 201 status - ObjectRoot)(For 200 status - CalculationStatusRoot)</returns>
        ...
        /// <param name="cacheControl">Standard HTTP header.  Accepts no-store, max-age, max-stale. (optional)</param>
        /// <param name="quantCalculationParametersRoot"> (optional)</param>
        /// <returns>ApiResponse of (For 202 status - CalculationStatusRoot)(For 201 status - ObjectRoot)(For 200 status - CalculationStatusRoot)</returns>
        ...
        /// <param name="quantCalculationParametersRoot"> (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of (For 202 status - CalculationStatusRoot)(For 201 status - ObjectRoot)(For 200 status - CalculationStatusRoot)</returns>
        ...
        /// <param name="quantCalculationParametersRoot"> (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse of (For 202 status - CalculationStatusRoot)(For 201 status - ObjectRoot)(For 200 status - CalculationStatusRoot)</returns>
