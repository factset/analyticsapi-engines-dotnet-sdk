...
namespace FactSet.AnalyticsAPI.Engines.Api
{
    ...
    public partial class SPARCalculationsApi : ISPARCalculationsApi
    {
        ...
        /// <summary>
        /// Get SPAR calculation by id This is the endpoint to check on the progress of a previously requested calculation.\\nIf the calculation has finished computing, the body of the response will contain the requested document in JSON.
        /// </summary>
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">from url, provided from the location header in the Run Calculation endpoint</param>
        /// <returns>Object</returns>
        ...
        /// <summary>
        /// Run SPAR Calculation This endpoint runs the SPAR calculation specified in the POST body parameters.\\nIt must be used first before polling or cancelling endpoints. \\nA successful response will contain the URL to poll for the result of the calculation.\\n\\nRemarks:\\n\\n* Any settings in POST body will act as a one-time override over the settings saved in the SPAR template.
        /// </summary>
        /// <exception cref="FactSet.AnalyticsAPI.Engines.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sPARCalculationParameters"> (optional)</param>
        /// <returns>Object</returns>
