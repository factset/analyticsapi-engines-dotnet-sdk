...
namespace FactSet.AnalyticsAPI.Engines.Model
{
    ...
    public partial class AFIOptimizationParameters : IEquatable<AFIOptimizationParameters>, IValidatableObject
    {
        ...
        public AFIOptimizationParameters(AFIOptimizerStrategy strategy = default(AFIOptimizerStrategy), OptimizerAccount account = default(OptimizerAccount), Optimization optimization = default(Optimization), OptimizerOutputTypes outputTypes = default(OptimizerOutputTypes))
        {
            ...
            this.Strategy = strategy ?? throw new ArgumentNullException("strategy is a required property for AFIOptimizationParameters and cannot be null");
            // to ensure "outputTypes" is required (not null)
            this.OutputTypes = outputTypes ?? throw new ArgumentNullException("outputTypes is a required property for AFIOptimizationParameters and cannot be null");
