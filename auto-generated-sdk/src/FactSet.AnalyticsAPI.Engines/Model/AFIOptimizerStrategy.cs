...
namespace FactSet.AnalyticsAPI.Engines.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AFIOptimizerStrategy")]
    public partial class AFIOptimizerStrategy : IEquatable<AFIOptimizerStrategy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AFIOptimizerStrategy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AFIOptimizerStrategy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AFIOptimizerStrategy" /> class.
        /// </summary>
        ...
        public AFIOptimizerStrategy(AFIOptimizerStrategyOverrides overrides = default(AFIOptimizerStrategyOverrides), string id = default(string))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for AFIOptimizerStrategy and cannot be null");
        ...
        public AFIOptimizerStrategyOverrides Overrides { get; set; }
        ...
        {
            return this.Equals(input as AFIOptimizerStrategy);
        }

        /// <summary>
        /// Returns true if AFIOptimizerStrategy instances are equal
        /// </summary>
        /// <param name="input">Instance of AFIOptimizerStrategy to be compared</param>
        /// <returns>Boolean</returns>
