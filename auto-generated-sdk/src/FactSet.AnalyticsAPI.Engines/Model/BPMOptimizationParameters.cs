...
namespace FactSet.AnalyticsAPI.Engines.Model
{
    ...
    public partial class BPMOptimizationParameters : IEquatable<BPMOptimizationParameters>, IValidatableObject
    {
        ...
        public BPMOptimizationParameters(BPMOptimizerStrategy strategy = default(BPMOptimizerStrategy), BPMOptimization optimization = default(BPMOptimization), OptimizerAccount account = default(OptimizerAccount), OptimizerOutputTypes outputTypes = default(OptimizerOutputTypes))
        {
            ...
            this.Strategy = strategy ?? throw new ArgumentNullException("strategy is a required property for BPMOptimizationParameters and cannot be null");
            // to ensure "outputTypes" is required (not null)
            this.OutputTypes = outputTypes ?? throw new ArgumentNullException("outputTypes is a required property for BPMOptimizationParameters and cannot be null");
