...
namespace FactSet.AnalyticsAPI.Engines.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FIStructuredProductsForJobSettings")]
    public partial class FIStructuredProductsForJobSettings : IEquatable<FIStructuredProductsForJobSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FIStructuredProductsForJobSettings" /> class.
        /// </summary>
        ...
        public FIStructuredProductsForJobSettings(FIServicerAdvances servicerAdvances = default(FIServicerAdvances), string ignoreFinancialGuarantee = default(string), bool cleanUpCallMethod = default(bool), string doOPTRedeem = default(string), FIPrepayLockout prepayLockout = default(FIPrepayLockout), FICashflows cashflows = default(FICashflows), FIBalloonExtension balloonExtension = default(FIBalloonExtension))
        {
        ...
        public FIServicerAdvances ServicerAdvances { get; set; }
        ...
        {
            return this.Equals(input as FIStructuredProductsForJobSettings);
        }

        /// <summary>
        /// Returns true if FIStructuredProductsForJobSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of FIStructuredProductsForJobSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FIStructuredProductsForJobSettings input)
        {
            if (input == null)
                return false;
