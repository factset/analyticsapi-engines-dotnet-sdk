...
namespace FactSet.AnalyticsAPI.Engines.Model
{
    ...
    public partial class NPOOptimizerStrategyOverrides : IEquatable<NPOOptimizerStrategyOverrides>, IValidatableObject
    {
        ...
        public NPOOptimizerStrategyOverrides(Dictionary<string, Object> objective = default(Dictionary<string, Object>), List<StringConstraintActionTuple> constraints = default(List<StringConstraintActionTuple>), string tax = default(string), string transactionCost = default(string), string alpha = default(string))
        {
