...
namespace FactSet.AnalyticsAPI.Engines.Model
{
    ...
    public partial class QuantFdsDate : IEquatable<QuantFdsDate>, IValidatableObject
    {
        ...
        public QuantFdsDate(string startDate = default(string), string endDate = default(string), SourceEnum source = default(SourceEnum), string frequency = default(string), string calendar = default(string), bool overrideUniversalScreenCalendar = default(bool))
        {
