...
namespace FactSet.AnalyticsAPI.Engines.Model
{
    ...
    public partial class QuantScreeningExpression : IEquatable<QuantScreeningExpression>, IValidatableObject
    {
        ...
        public QuantScreeningExpression(string expr = default(string), string name = default(string), string dateOffset = default(string), SourceEnum source = default(SourceEnum))
        {
