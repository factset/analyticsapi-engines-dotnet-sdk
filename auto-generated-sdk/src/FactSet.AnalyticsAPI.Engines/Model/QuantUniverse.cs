...
namespace FactSet.AnalyticsAPI.Engines.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(QuantIdentifierUniverse), "QuantIdentifierUniverse")]
    [JsonSubtypes.KnownSubType(typeof(QuantScreeningExpressionUniverse), "QuantScreeningExpressionUniverse")]
    [JsonSubtypes.KnownSubType(typeof(QuantUniversalScreenUniverse), "QuantUniversalScreenUniverse")]
    public partial class QuantUniverse : IEquatable<QuantUniverse>, IValidatableObject
    {
        ...
        public QuantUniverse(string type = default(string), SourceEnum source = default(SourceEnum))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for QuantUniverse and cannot be null");
            this.Source = source;
        }
