...
namespace FactSet.AnalyticsAPI.Engines.Model
{
    ...
    public partial class SMCreateParameters : IEquatable<SMCreateParameters>, IValidatableObject
    {
        ...
        public SMCreateParameters(string securityName = default(string), string location = default(string), string asofdate = default(string), OneOfSMFields fields = default(OneOfSMFields))
        {
            // to ensure "securityName" is required (not null)
            this.SecurityName = securityName ?? throw new ArgumentNullException("securityName is a required property for SMCreateParameters and cannot be null");
            // to ensure "fields" is required (not null)
            this.Fields = fields ?? throw new ArgumentNullException("fields is a required property for SMCreateParameters and cannot be null");
