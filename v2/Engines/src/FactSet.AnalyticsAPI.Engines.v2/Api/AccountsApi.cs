...
namespace FactSet.AnalyticsAPI.Engines.v2.Api
{
    ...
    public interface IAccountsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<AccountDirectories> GetAccountsAsync (string path);
        ...
        System.Threading.Tasks.Task<ApiResponse<AccountDirectories>> GetAccountsAsyncWithHttpInfo (string path);
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        /// <returns></returns>
        public AccountsApi(FactSet.AnalyticsAPI.Engines.v2.Client.Configuration configuration)
        {
        ...
        public AccountsApi(FactSet.AnalyticsAPI.Engines.v2.Client.ISynchronousClient client,FactSet.AnalyticsAPI.Engines.v2.Client.IAsynchronousClient asyncClient, FactSet.AnalyticsAPI.Engines.v2.Client.IReadableConfiguration configuration)
        {
        ...
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<AccountDirectories> localVarResponse = GetAccountsWithHttpInfo(path);
        ...
        /// <param name="path">The directory to get the accounts and sub-directories in</param>
        /// <returns>ApiResponse of AccountDirectories</returns>
        public FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse< AccountDirectories > GetAccountsWithHttpInfo (string path)
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.AnalyticsAPI.Engines.v2.Client.ApiException(400, "Missing required parameter 'path' when calling AccountsApi->GetAccounts");
            ...
            var response = this.Client.Get< AccountDirectories >("/analytics/lookups/v2/accounts/{path}", requestOptions, this.Configuration);
        ...
        /// <param name="path">The directory to get the accounts and sub-directories in</param>
        /// <returns>Task of AccountDirectories</returns>
        public async System.Threading.Tasks.Task<AccountDirectories> GetAccountsAsync (string path)
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<AccountDirectories> localVarResponse = await GetAccountsAsyncWithHttpInfo(path);
             return localVarResponse.Data;
        ...
        /// <param name="path">The directory to get the accounts and sub-directories in</param>
        /// <returns>Task of ApiResponse (AccountDirectories)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<AccountDirectories>> GetAccountsAsyncWithHttpInfo (string path)
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new FactSet.AnalyticsAPI.Engines.v2.Client.ApiException(400, "Missing required parameter 'path' when calling AccountsApi->GetAccounts");
            ...
            var response = await this.AsynchronousClient.GetAsync<AccountDirectories>("/analytics/lookups/v2/accounts/{path}", requestOptions, this.Configuration);
