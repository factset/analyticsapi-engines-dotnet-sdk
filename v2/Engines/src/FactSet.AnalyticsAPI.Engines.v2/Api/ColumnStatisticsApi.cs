...
namespace FactSet.AnalyticsAPI.Engines.v2.Api
{
    ...
    public partial class ColumnStatisticsApi : IColumnStatisticsApi
    {
        ...
        /// <returns></returns>
        public ColumnStatisticsApi(FactSet.AnalyticsAPI.Engines.v2.Client.Configuration configuration)
        {
        ...
        public ColumnStatisticsApi(FactSet.AnalyticsAPI.Engines.v2.Client.ISynchronousClient client,FactSet.AnalyticsAPI.Engines.v2.Client.IAsynchronousClient asyncClient, FactSet.AnalyticsAPI.Engines.v2.Client.IReadableConfiguration configuration)
        {
        ...
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<Dictionary<string, ColumnStatistic>> localVarResponse = GetPAColumnStatisticsWithHttpInfo();
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.v2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Dictionary&lt;string, ColumnStatistic&gt;</returns>
        public FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse< Dictionary<string, ColumnStatistic> > GetPAColumnStatisticsWithHttpInfo ()
        {
            ...
            var response = this.Client.Get< Dictionary<string, ColumnStatistic> >("/analytics/lookups/v2/engines/pa/columnstatistics", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetPAColumnStatistics", response);
        ...
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<Dictionary<string, ColumnStatistic>> localVarResponse = await GetPAColumnStatisticsAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.v2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, ColumnStatistic&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<Dictionary<string, ColumnStatistic>>> GetPAColumnStatisticsAsyncWithHttpInfo ()
        {
            ...
            var response = await this.AsynchronousClient.GetAsync<Dictionary<string, ColumnStatistic>>("/analytics/lookups/v2/engines/pa/columnstatistics", requestOptions, this.Configuration);
