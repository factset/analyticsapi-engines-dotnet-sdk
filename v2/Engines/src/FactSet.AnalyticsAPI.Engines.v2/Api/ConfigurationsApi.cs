...
namespace FactSet.AnalyticsAPI.Engines.v2.Api
{
    ...
    public partial class ConfigurationsApi : IConfigurationsApi
    {
        ...
        /// <returns></returns>
        public ConfigurationsApi(FactSet.AnalyticsAPI.Engines.v2.Client.Configuration configuration)
        {
        ...
        public ConfigurationsApi(FactSet.AnalyticsAPI.Engines.v2.Client.ISynchronousClient client,FactSet.AnalyticsAPI.Engines.v2.Client.IAsynchronousClient asyncClient, FactSet.AnalyticsAPI.Engines.v2.Client.IReadableConfiguration configuration)
        {
        ...
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<VaultConfiguration> localVarResponse = GetVaultConfigurationByIdWithHttpInfo(id);
        ...
        /// <param name="id">Vault configuration id to get the details of</param>
        /// <returns>ApiResponse of VaultConfiguration</returns>
        public FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse< VaultConfiguration > GetVaultConfigurationByIdWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.AnalyticsAPI.Engines.v2.Client.ApiException(400, "Missing required parameter 'id' when calling ConfigurationsApi->GetVaultConfigurationById");
            ...
            var response = this.Client.Get< VaultConfiguration >("/analytics/lookups/v2/engines/vault/configurations/{id}", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetVaultConfigurationById", response);
        ...
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<VaultConfiguration> localVarResponse = await GetVaultConfigurationByIdAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">Vault configuration id to get the details of</param>
        /// <returns>Task of ApiResponse (VaultConfiguration)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<VaultConfiguration>> GetVaultConfigurationByIdAsyncWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new FactSet.AnalyticsAPI.Engines.v2.Client.ApiException(400, "Missing required parameter 'id' when calling ConfigurationsApi->GetVaultConfigurationById");
            ...
            var response = await this.AsynchronousClient.GetAsync<VaultConfiguration>("/analytics/lookups/v2/engines/vault/configurations/{id}", requestOptions, this.Configuration);
        ...
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<Dictionary<string, VaultConfigurationSummary>> localVarResponse = GetVaultConfigurationsWithHttpInfo(account);
             return localVarResponse.Data;
        }
        ...
        /// <param name="account">Required account query parameter to filter configurations for a specific account</param>
        /// <returns>ApiResponse of Dictionary&lt;string, VaultConfigurationSummary&gt;</returns>
        public FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse< Dictionary<string, VaultConfigurationSummary> > GetVaultConfigurationsWithHttpInfo (string account)
        {
            // verify the required parameter 'account' is set
            if (account == null)
                throw new FactSet.AnalyticsAPI.Engines.v2.Client.ApiException(400, "Missing required parameter 'account' when calling ConfigurationsApi->GetVaultConfigurations");
            ...
            var response = this.Client.Get< Dictionary<string, VaultConfigurationSummary> >("/analytics/lookups/v2/engines/vault/configurations", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetVaultConfigurations", response);
                if (exception != null) throw exception;
            }
        ...
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<Dictionary<string, VaultConfigurationSummary>> localVarResponse = await GetVaultConfigurationsAsyncWithHttpInfo(account);
             return localVarResponse.Data;
        ...
        /// <param name="account">Required account query parameter to filter configurations for a specific account</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, VaultConfigurationSummary&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<Dictionary<string, VaultConfigurationSummary>>> GetVaultConfigurationsAsyncWithHttpInfo (string account)
        {
            // verify the required parameter 'account' is set
            if (account == null)
                throw new FactSet.AnalyticsAPI.Engines.v2.Client.ApiException(400, "Missing required parameter 'account' when calling ConfigurationsApi->GetVaultConfigurations");
            ...
            var response = await this.AsynchronousClient.GetAsync<Dictionary<string, VaultConfigurationSummary>>("/analytics/lookups/v2/engines/vault/configurations", requestOptions, this.Configuration);
