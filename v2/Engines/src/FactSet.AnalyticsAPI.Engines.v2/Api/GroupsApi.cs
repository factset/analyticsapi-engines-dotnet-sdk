...
namespace FactSet.AnalyticsAPI.Engines.v2.Api
{
    ...
    public interface IGroupsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Dictionary<string, Group>> GetPAGroupsAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<Dictionary<string, Group>>> GetPAGroupsAsyncWithHttpInfo ();
    ...
    public partial class GroupsApi : IGroupsApi
    {
        ...
        /// <returns></returns>
        public GroupsApi(FactSet.AnalyticsAPI.Engines.v2.Client.Configuration configuration)
        {
        ...
        public GroupsApi(FactSet.AnalyticsAPI.Engines.v2.Client.ISynchronousClient client,FactSet.AnalyticsAPI.Engines.v2.Client.IAsynchronousClient asyncClient, FactSet.AnalyticsAPI.Engines.v2.Client.IReadableConfiguration configuration)
        {
        ...
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<Dictionary<string, Group>> localVarResponse = GetPAGroupsWithHttpInfo();
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.v2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Dictionary&lt;string, Group&gt;</returns>
        public FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse< Dictionary<string, Group> > GetPAGroupsWithHttpInfo ()
        {
            ...
            var response = this.Client.Get< Dictionary<string, Group> >("/analytics/lookups/v2/engines/pa/groups", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetPAGroups", response);
        ...
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<Dictionary<string, Group>> localVarResponse = await GetPAGroupsAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="FactSet.AnalyticsAPI.Engines.v2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, Group&gt;)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<Dictionary<string, Group>>> GetPAGroupsAsyncWithHttpInfo ()
        {
            ...
            var response = await this.AsynchronousClient.GetAsync<Dictionary<string, Group>>("/analytics/lookups/v2/engines/pa/groups", requestOptions, this.Configuration);
