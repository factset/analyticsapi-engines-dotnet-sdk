...
namespace FactSet.AnalyticsAPI.Engines.v2.Api
{
    ...
    public partial class UtilityApi : IUtilityApi
    {
        ...
        /// <returns></returns>
        public UtilityApi(FactSet.AnalyticsAPI.Engines.v2.Client.Configuration configuration)
        {
        ...
        public UtilityApi(FactSet.AnalyticsAPI.Engines.v2.Client.ISynchronousClient client,FactSet.AnalyticsAPI.Engines.v2.Client.IAsynchronousClient asyncClient, FactSet.AnalyticsAPI.Engines.v2.Client.IReadableConfiguration configuration)
        {
        ...
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<string> localVarResponse = GetByUrlWithHttpInfo(url);
        ...
        /// <param name="url">Url of the GET endpoint</param>
        /// <returns>ApiResponse of string</returns>
        public FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<string> GetByUrlWithHttpInfo (string url)
        {
            // verify the required parameter 'url' is set
            if (url == null)
                throw new FactSet.AnalyticsAPI.Engines.v2.Client.ApiException(400, "Missing required parameter 'url' when calling UtilityApi->GetByUrl");
            ...
            var response = this.Client.Get<string>(url, requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetByUrl", response);
        ...
        {
             FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<string> localVarResponse = await GetByUrlAsyncWithHttpInfo(url);
             return localVarResponse.Data;
        ...
        /// <param name="url">Url of the GET endpoint</param>
        /// <returns>Task of ApiResponse(string)</returns>
        public async System.Threading.Tasks.Task<FactSet.AnalyticsAPI.Engines.v2.Client.ApiResponse<string>> GetByUrlAsyncWithHttpInfo (string url)
        {
            // verify the required parameter 'url' is set
            if (url == null)
                throw new FactSet.AnalyticsAPI.Engines.v2.Client.ApiException(400, "Missing required parameter 'url' when calling ->GetByUrl");
            ...
            var response = await this.AsynchronousClient.GetAsync<string>(url, requestOptions, this.Configuration);
