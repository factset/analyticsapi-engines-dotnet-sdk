...
namespace FactSet.AnalyticsAPI.Engines.v2.Client
{
    /// <summary>
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        public ApiClient()
        {
            _baseUrl = FactSet.AnalyticsAPI.Engines.v2.Client.GlobalConfiguration.Instance.BasePath;
        }
        ...
        private ApiResponse<T> toApiResponse<T>(IRestResponse<T> response)
        {
            ...
            var transformed = new ApiResponse<T>(response.StatusCode, new Multimap<string, string>(StringComparer.OrdinalIgnoreCase), result)
            {
