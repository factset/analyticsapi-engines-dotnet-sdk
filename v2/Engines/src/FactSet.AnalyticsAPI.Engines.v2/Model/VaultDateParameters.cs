...
namespace FactSet.AnalyticsAPI.Engines.v2.Model
{
    ...
    public partial class VaultDateParameters :  IEquatable<VaultDateParameters>, IValidatableObject
    {
        ...
        public VaultDateParameters(string startdate = default(string), string enddate = default(string), string frequency = default(string))
        {
            ...
            if (enddate == null)
            {
                throw new InvalidDataException("enddate is a required property for VaultDateParameters and cannot be null");
            }
            else
            {
            ...
            if (frequency == null)
            {
                throw new InvalidDataException("frequency is a required property for VaultDateParameters and cannot be null");
            }
            else
            {
